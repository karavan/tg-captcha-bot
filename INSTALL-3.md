...
```bash
wget https://github.com/mxssl/tg-captcha-bot/releases/download/v1.1.17/tg-captcha-bot_1.1.17_linux_amd64.tar.gz

tar xvzf tg-captcha-bot_1.1.17_linux_amd64.tar.gz
